...
-- AlterTable
ALTER TABLE "TeamMember" ADD COLUMN     "secondaryPolesJson" TEXT NOT NULL DEFAULT '[]',
ADD COLUMN     "userId" TEXT,
ALTER COLUMN "pole" DROP NOT NULL,
ALTER COLUMN "personalAe2vEmail" DROP NOT NULL;

-- AlterTable
ALTER TABLE "User" ALTER COLUMN "emailPrefs" SET DEFAULT ARRAY[]::TEXT[];
...
-- Refonte Bureau : préférences email, désinscription opaque et ordre public de l'équipe.
-- À appliquer uniquement après sauvegarde et validation de l'environnement PostgreSQL.
ALTER TABLE "User"
ADD COLUMN "emailUnsubscribedAt" TIMESTAMP(3),
ADD COLUMN "emailPreferenceToken" TEXT;
