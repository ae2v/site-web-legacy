...
import { ArrowUpRight, CalendarDays, Instagram, Mail, Ticket } from "lucide-react";
...
import { publicEvents, type Ae2vEvent } from "@/data/events";
  ...
  head: () => ({
    meta: [
      { title: "AE2V — Le BDE de l'IUT de Vélizy" },
      {
        name: "description",
        content:
          "Événements, projets et vie de campus à Vélizy. AE2V : toujours plus loin, ensemble.",
      },
      { property: "og:title", content: "AE2V — Le BDE de l'IUT de Vélizy" },
      {
        property: "og:description",
        content: "Événements, projets et vie de campus à Vélizy.",
      },
          ...
          <div>
            ...
            <Reveal delay={320}>
              <p className="mt-6 max-w-xl text-base md:text-lg">
                L'AE2V fait vivre le campus : événements, projets et avantages étudiants, le tout
                au même endroit.
              </p>
          ...
          <Reveal delay={120} className="relative border-2 border-ae2v-black bg-ae2v-black/35 p-6">
            ...
            <ul className="flex flex-col gap-3 text-sm">
              {[
                ...
                "Échanges et annonces sur Discord",
                "Des projets construits avec les étudiants",
              ].map((item) => (
